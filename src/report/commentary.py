...
def fallback_commentary(comps: pd.DataFrame, headlines: pd.DataFrame | None) -> dict[str, Any]:
    ...
    result: dict[str, Any] = {
        ...
        "bullets": [],
        "watch_items": [],
        # source carries the human-readable detail; source_kind is the machine
        # discriminator the dashboard badge reads. Both are always set together.
